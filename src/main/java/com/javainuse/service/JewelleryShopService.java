...
public class JewelleryShopService {
	...
	public void  generateCampaigns(){
		this.eligibleCampaigns.add(new Campaign(1L, "%10 indirim kampanyası", "single", new Benefit(1L, "discount by percentage",  new Discount("percent", 10.0))));
		this.eligibleCampaigns.add(new Campaign(2L,  "100TL indirim kampanyası", "single", new Benefit(2L, "discount by cash",  new Discount("cash", 100.0))));
		...
		this.eligibleCampaigns.add(new Campaign(5L, "Seçili üründe %10 indirim kampanyası", "single", new Benefit(5L, "discount by percentage",  new Discount("percent", 10.0))));
		this.eligibleCampaigns.add(new Campaign(6L,  "Seçili üründe 20TL indirim kampanyası", "single", new Benefit(6L, "discount by cash",  new Discount("cash", 20.0))));
